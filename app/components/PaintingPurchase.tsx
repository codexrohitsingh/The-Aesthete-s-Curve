...
export default function PaintingPurchase({ 
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F0] py-12 relative">
      {/* Toast Notifications */}
      {showToast && (
        <div className="fixed top-20 right-4 bg-[#5C4033] text-[#FAF7F0] px-6 py-4 rounded-lg shadow-lg z-50 animate-fade-in max-w-sm">
      ...
      {showCartToast && (
        <div className="fixed top-20 right-4 bg-green-600 text-white px-6 py-4 rounded-lg shadow-lg z-50 animate-fade-in max-w-sm">
          <div className="flex items-start gap-3">
            <svg className="w-6 h-6 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-4xl mx-auto bg-white/80 rounded-lg shadow-xl p-8 border border-[#E8DFD3]">
        <h2 className="text-center text-[#7D6E5F] text-lg mb-8 font-light">
          One step to receive your painting...
        </h2>

        <div className="flex flex-col items-center mb-8">
          <div className="relative w-80 h-80">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-1 h-12 bg-[#C4B5A0]"></div>
            <div className="absolute top-12 left-1/2 transform -translate-x-1/2 w-40 h-0.5 bg-[#C4B5A0]"></div>
        ...
        <div className="text-center mb-6">
          <h1 className="text-3xl font-light mb-2 text-[#3E2A1F]" style={{ fontFamily: 'serif' }}>{title}</h1>
          <p className="text-[#7D6E5F] font-light">
            8 inches × 8 inches • Wood & hardboard
          </p>
        </div>

        <div className="text-center mb-8">
          <p className="text-4xl font-light text-[#3E2A1F]">{price}</p>
        </div>

        <div className="mb-8">
          <h3 className="text-sm font-light mb-4 text-[#5C4033] tracking-wider">
            SELECT FRAME COLOR
          </h3>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-center gap-4">
            <button 
              ...
              className="bg-white border-2 border-[#5C4033] text-[#5C4033] px-8 py-3 rounded-full hover:bg-[#FAF7F0] transition-colors font-light"
            >
              Add to Cart
            </button>
            <button 
              ...
              className="bg-[#5C4033] text-[#FAF7F0] px-8 py-3 rounded-full hover:bg-[#3E2A1F] transition-colors font-light flex items-center gap-2"
            >
